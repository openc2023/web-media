...
const DICTIONARIES = {
    "zh-CN": {
        ...
        top: {
            ...
            statusDesktopPreview: "桌面浏览器仅显示摄像头预览。请用真机手机浏览器进行 AR 识别。",
    ...
    en: {
        ...
        top: {
            ...
            code: "000-top",
            index: "01",
            heading: "View The Work",
            lead: "Find the artwork, then start recognition.",
            ...
            statusDesktopPreview: "Desktop browser is running in camera preview mode only. Use a real mobile browser for AR recognition.",
    ...
    ko: {
        ...
        top: {
            ...
            statusDesktopPreview: "데스크톱 브라우저에서는 카메라 미리보기만 표시됩니다. AR 인식은 실제 휴대폰 브라우저에서 테스트해 주세요.",
